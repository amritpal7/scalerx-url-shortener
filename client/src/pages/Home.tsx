    ...
    <div className="flex flex-col items-center justify-center mt-25 md:px-30 lg:px-40">
      <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-10 mt-10 px-4 max-w-6xl mx-auto">
        ...
        <div className="text-center md:text-left flex-1">
          <h1 className="text-3xl md:text-5xl text-[#6B62FF] font-bold mb-4">
            Simplify Your Links, Instantly
          </h1>
          <p className="text-lg md:text-xl text-white dark:text-white mb-5">
          ...
          {user ? (
            ...
            <Link to="/register">
              <button className="cursor-pointer group relative bg-white text-black font-semibold text-sm px-6 py-3 rounded-full transition-all duration-200 ease-in-out shadow hover:shadow-lg w-40 h-12">

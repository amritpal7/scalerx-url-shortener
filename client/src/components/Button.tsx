...
function Button({ children }: props) {
  return (
    <div className="flex items-center justify-center mt-10 md:justify-end">
      <div className="relative w-[100px] h-[40px]">
        <button className="group relative w-full h-full flex items-center justify-center cursor-pointer bg-black text-white font-bold border-4 border-white outline-4 outline-black shadow-[6px_6px_0_#00a4ef] px-4 box-border overflow-hidden transition-all duration-100 ease-out active:translate-x-[4px] active:translate-y-[4px] active:shadow-none active:bg-white active:text-black active:border-black">
          {/* Shimmer effect */}
          <span
